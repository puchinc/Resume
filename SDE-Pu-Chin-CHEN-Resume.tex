...
%------------------------------------------
\section{\Large\bf\textsc{Extra Curricular Activity}}
\begin{tabular}{p{18.5cm}}
...
\item Integrated cross-department communication and directed a technical team to build official websites, web game and bicycle tail light for marketing purpose; Technobogies included {\bf NodeJS, ReactJS, AnuglarJS}, Dart and Arduino.\vspace*{-\baselineskip}
...
\begin{tabular}{p{18.5cm}}
{\bf{Proficient in:}} Java, C/C++, Python, NodeJS, SQL, Git, Linux
\hspace{16.3mm} {\bf{Familiar with:}} ReactJS, AngularJS, PHP, {\fb \LaTeX}\\
{\bf{Languages:}} Native in Mandarin; Fluent in English
\hspace{30mm} {\bf{Interests:}} \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance}, Coffee, Chinese History\\
