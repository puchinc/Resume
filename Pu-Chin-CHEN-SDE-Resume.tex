...
\begin{tabular}{p{18.5cm}}
{\textbf{Proficient in:}} Java, C/C++, PHP, JavaScript, NodeJS, SQL, MongoDB, Git
\hspace{5mm} {\textbf{Familiar with:}} Python, ReactJS, UNIX shell script, {\fb \LaTeX}\\ 
{\textbf{Languages:}} Native in Mandarin; Fluent in English
\hspace{35.3mm} {\textbf{Interests:}} Street Dance, Swing Dance, Chinese History\\
