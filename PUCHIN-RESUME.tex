...
%\vspace*{-1.3cm}
\vspace*{-8mm}
\par{\centering{\huge\textbf{Puchin (Michael) Chen}}\par} % Your name
% \section{Personal Data}

% \begin{tabular}{rl}
\centering{
10933 Rochester Ave., Los Angeles, CA 90024, USA\\
    +1 (702) 217-0125 \hspace{2 mm}|\hspace{2 mm}\href{mailto:puching110@gmail.com}{\underline{puching110@gmail.com}}\hspace{2 mm}|\hspace{2mm}\href{https://www.linkedin.com/in/puchinchen}{\faLinkedinSign \hspace{1 mm}\underline{www.linkedin.com/in/puchinchen}}
% \end{tabular}
...
{\it Software Engineering Intern} \hfill June 2018 - Sep. 2018\\%& \it Taipei, Taiwan\\
\begin{itemize}
\vspace{-3mm}
%PayPal’s private cloud has grown from a few thousand servers to over 15K+ servers running 180K+ Virtual Machines (VM).
%We face a challenge. In the last few years, PayPal’s private cloud has grown from a few thousand servers to over 15K+ servers running 180K+ Virtual Machines (VM). Due to the quick proliferation, the placement and sizing of VMs are not as optimized as they should be.

%We want you to help us design a solution that can lead to different strategies for placing and sizing VMs and minimize the cost of hardware while still meeting the capacity needs of the PayPal engineering teams.
...
\begin{tabular}{p{18.5cm}}
{\bf{Programming Languages:}} Python, JavaScript, Java, C/C++
\hspace{18mm} {\bf{RDBMS:}} MySQL, MongoDB\\
{\bf{Machine Learning:}} Tensorflow, PyTorch, scikit-learn, numpy, pandas
\hspace{3.1mm} {\bf{Tools:}} Vim, Git, Bash, Docker \\
{\bf{Web Development:}} HTML/CSS, ReactJS, NodeJS
\hspace{30.5mm} {\bf{Languages:}} Native in Mandarin; fluent in English\\
\end{tabular}
