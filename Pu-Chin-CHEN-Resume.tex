...
{\bf{University of California, Los Angeles (UCLA)}}  \hfill \bf{Distance Education in the 1\st year}\\
...
% {\bf{Teaching Assistant}} \hfill \textbf{Taipei, Taiwan}\\
...
\begin{tabular}{p{18.5cm}}
{\bf{Proficient in:}} Java, Python, SQL, C/C++, JavaScript, Linux, Git
\hspace{7mm} {\bf{Familiar with:}} PHP, NodeJS, MongoDB, {\fb \LaTeX}\\
{\bf{Languages:}} Native in Mandarin; Fluent in English
\hspace{25mm} {\bf{Interests:}} \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance}, Coffee, Chinese History\\
