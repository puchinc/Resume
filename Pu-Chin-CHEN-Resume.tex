...
+1 (702) 217-0125 \hspace{2 mm}|\hspace{2 mm}\href{mailto:puchinchen@cs.ucla.edu}{\underline{puchinchen@cs.ucla.edu}}\hspace{2 mm}|\hspace{2mm}\href{https://michaelchen110.github.io}{\faGithub \hspace{1 mm}\underline{https://michaelchen110.github.io/}} %\hspace{2 mm}\href{https://github.com/michaelchen110}{\faGithub \hspace{1 mm} github.com/michaelchen110}\\
...
%\item GPA: 3.93/4.0; GRE: Q170/170 (Top 3\%)
\item Research Area: Natural Language Processing; Advisor: Kai-Wei Chang 
\item Coursework: Database Systems, Data Mining, Data Science Principles, Natural Language Processing, Computer Security; Anticipated Courses: Software Engineering, Artificial Intelligence \vspace*{-\baselineskip}%; GRE: Q170
\end{itemize}\\ 
\vspace{.1mm}
...
\begin{itemize}
\vspace{-3mm}
%\item Reduced 60\% of code size by refactoring music genre prediction system from Theano to Tensorflow/Keras 
%\item Constructed deep learning pipeline and deployed on {\bf Docker}, including crawler, word parser and ETL tools  
...
{\bf{Tools:}} Tensorflow, Keras, scikit-learn, Git, Linux, Docker, NodeJS, {\fb \LaTeX}
\hspace{-0.8mm} {\bf{Interests:}} Vim, \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance}, Music\\
