...
{\large\bf{University of California, Los Angeles (UCLA)}}  \hfill \bf{Distance Education in the 1\st year}\\
{\it M.S. in Data Science Engineering} \hfill  Sept. 2016-Present
\begin{itemize}
\item Coursework: Database Systems, Data Mining; Anticipated Courses: Big Data Systems, Artificial Intelligence, Pattern Recognition and Machine Learning, Computer Security, Database and Knowledge Bases, Convex Optimization%; GRE: Q170
\item GPA: 4.0/4.0; GRE: Q170/170 (\textbf{Top 3\%})\vspace*{-\baselineskip}
\end{itemize}\\ 
\vspace{0.1mm}
...
{\it Far EasTone Telecommunications Co.} \hfill  Jan. 2017-Present\\%& \it Taipei, Taiwan\\
\begin{itemize}
\vspace{-3mm}
...
% {\large\bf{Teaching Assistant}} \hfill \textbf{Taipei, Taiwan}\\
% {\it Data Structures and Algorithms} \hfill  Mar. 2015-June 2015 \\%& \it Taipei, Taiwan\\
% \begin{itemize}
% \vspace{-3mm}
% \item Developed grading tools by Linux for programming assignments; Resolved students' questions in a timely manner.
...
{\it DiQi Inc. (Blockchain Technology Startup)}\hfill  Oct. 2014-Feb. 2015  \\%& \it Taipei, Taiwan\\ 
% \footnotesize{
\begin{itemize}
\vspace{-3mm}
...
% \item Integrated cross-department communication and directed a technical team to build official websites, web game and bicycle tail light for marketing purpose; Technobogies included NodeJS, ReactJS, AnuglarJS, Dart and Arduino.\vspace*{-\baselineskip}
...
\begin{tabular}{p{18.5cm}}
{\large\bf{Proficient in:}} Java, Python, SQL, C/C++, JavaScript, Linux, Git
\hspace{7mm} {\large\bf{Familiar with:}} PHP, NodeJS, MongoDB, {\fb \LaTeX}\\
{\large\bf{Languages:}} Native in Mandarin; Fluent in English
\hspace{25mm} {\large\bf{Interests:}} \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance}, Coffee, Chinese History\\
