...
\begin{tabular}{p{18.5cm}}
{\textbf{Proficient in:}} Java, C/C++, Python, SQL, MongoDB, Git
\hspace{5mm} {\textbf{Familiar with:}} PHP, JavaScript, NodeJS, ReactJS, UNIX shell script, {\fb \LaTeX}\\ 
{\textbf{Languages:}} Native in Mandarin; Fluent in English
	\hspace{12.1mm} {\textbf{Interests:}} \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance, Swing Dance}, Chinese History\\
