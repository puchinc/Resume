...
\begin{itemize}
\item Coursework: Database Systems, Data Mining; Anticipated Courses: Big Data Systems, Social Network Analysis, Pattern Recognition and Machine Learning, Convex Optimization, Bayesian Networks, Monte Carlo Methods for Optimization%; GRE: Q170
...
% {\it Data Structured and Algorithms} \hfill  Mar. 2015-June 2015 \\%& \it Taipei, Taiwan\\
% \begin{itemize}
% \vspace{-2mm}
...
\begin{tabular}{p{18.5cm}}
{\textbf{Proficient in:}} Java, C/C++, JavaScript, SQL, Python, MongoDB
\hspace{5mm} {\textbf{Familiar with:}} PHP, NodeJS, ReactJS, UNIX shell script, Git, {\fb \LaTeX}\\ 
{\textbf{Languages:}} Native in Mandarin; Fluent in English
	\hspace{22.1mm} {\textbf{Interests:}} \href{https://www.youtube.com/playlist?list=PLVWomxSv1AgmLxMTgWlp6P3LFdct88ImL}{Street Dance, Swing Dance}, Chinese History\\
